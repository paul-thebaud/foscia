...
[**Read the FAQ to understand the why.**](/docs/help/faq#why-classes-are-used-for-models-in-typescript)
...
- [**Configure your action factory**](/docs/guides/action-factory-configuration)
- [**Implement custom action factory**](/docs/guides/custom-action-factory)
...
You may [learn more about extensions](/docs/core-concepts/actions#extensions),
