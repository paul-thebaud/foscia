...
- [**Configure your action factory**](/docs/advanced/action-factory-configuration)
- [**Implement custom action factory**](/docs/advanced/custom-action-factory)
...
```javascript
import { forModel, include, all } from 'func-client/core';
...
```javascript
import { forInstance, raw } from 'func-client/core';
