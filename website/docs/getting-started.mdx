...
blueprints: [JSON:API](https://jsonapi.org) or REST.
...
You can read more details on the
[REST implementation page](/docs/advanced/implementations/rest).
...
Using JSON:API or REST blueprints, you may also want to use Foscia to
