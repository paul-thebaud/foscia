...
<FunctionInfo provides="Model, Type" />
...
<FunctionInfo provides="Model, Instance, Type, ID" />
...
<FunctionInfo provides="Model, Instance, Type, ID, Relation" />
...
- [`{I extends ModelInstance}`](/docs/api/func-client/modules/core#modelinstance) `instance` the instance to use
- [`{ModelRelationKey<I>}`](/docs/api/func-client/modules/core#modelrelationkey) `relation` the relation to use
...
<FunctionInfo provides="Model, Type, ID" />
...
<FunctionInfo
  requires="Serializer"
  provides="Model, Instance, Type, ID"
/>
