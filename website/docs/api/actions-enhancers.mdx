...
- [`{M extends Model}`](/docs/api/foscia/modules/core#model) `model` the model class to use
...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance) `instance` the instance to use
...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance) `instance` the instance to use
- [`{ModelRelationKey<I>}`](/docs/api/foscia/modules/core#modelrelationkey) `relationKey` the relation to use
...
- [`{ModelId | undefined}`](/docs/api/foscia/modules/core#modelid) `id` the ID to use
...
- [`{M extends Model}`](/docs/api/foscia/modules/core#model) `model` the model class to use
- [`{ModelId}`](/docs/api/foscia/modules/core#modelid) `id` the ID to use
...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance)
...
- [`{ArrayableVariadic<ModelRelationDotKey<M>>}`](/docs/api/foscia/modules/core#modelrelationdotkey)
...
- [`{HttpRequestConfig | undefined}`](/docs/api/foscia/modules/http#httprequestconfig) `config`
...
- `{string}` `pathOrBaseURL` a path or base URL for the request
- [`{HttpRequestConfig['body'] | undefined}`](/docs/api/foscia/modules/http#httprequestconfig) `body`
a request body
- [`{HttpRequestConfig | undefined}`](/docs/api/foscia/modules/http#httprequestconfig) `config`
a request configuration object
...
- [`{ArrayableVariadic<ModelKey<M>>}`](/docs/api/foscia/modules/core#modelkey) `...fieldset` a
...
- [`{M extends ModelClass<D>}`](/docs/api/foscia/modules/core#modelclass) `model` the model
