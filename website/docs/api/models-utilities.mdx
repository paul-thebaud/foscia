...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance) `instance`
- [`{Partial<ModelValues<I>>}`](/docs/api/foscia/modules/core#modelvalues) `values`
...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance) `instance`
- [`{ArrayableVariadic<ModelKey<I>}`](/docs/api/foscia/modules/core#modelkey) `...keys`
...
- [`{I extends ModelInstance}`](/docs/api/foscia/modules/core#modelinstance) `instance`
- [`{ArrayableVariadic<ModelRelationDotKey<I>>}`](/docs/api/foscia/modules/core#modelrelationdotkey) `...relations`
...
- [`{ModelConfig | string}`](/docs/api/foscia/modules/core#modelconfig) `config`
- `{ModelDefinition}` `rawDefinition`

#### Returns

[`{ModelClass}`](/docs/api/foscia/modules/core#modelclass)
...
- [`{ModelConfig | undefined}`](/docs/api/foscia/modules/core#modelconfig) `baseConfig` (omitting `type`)
...
[`{ModelParsedDefinition}`](/docs/api/foscia/modules/core#modelparseddefinition)
