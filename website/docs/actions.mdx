...
to set up your environment easily:
...
[custom action factory guide](/docs/advanced/custom-action-factory).
...
Every enhancers and runners of FuncClient provide a `.extension` property
